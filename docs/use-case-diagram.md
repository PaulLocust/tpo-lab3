...
actor "Гость" as Guest
  ...
  usecase "UC-07: Сложный маршрут / Лечу по работе" as UC07
  usecase "UC-08: Выбор даты вылета (календарь)" as UC08
  usecase "UC-09: Открытие селектора пассажиров" as UC09
...
flowchart LR
    ...
    subgraph TT ["T-Путешествия"]
        ...
        UC07["UC-07: Сложный маршрут / Work-trip"]
...
| UC-07 | Сложный маршрут / тоггл «Лечу по работе»|        ✓        | `<<extend>>` UC-03              |
